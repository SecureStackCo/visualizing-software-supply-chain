...
|             | Git repos     | Package Managers | Git repos     | Functional tests     | Application servers | GPU/CPU     |          | Identity Providers |                 |
|             | Page Builders | Proprietary code |               | Security tests       | Web engines         |             |          | Analytics          |                 |
